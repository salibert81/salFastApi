...
# WARNING: Ensure imports from `salfastapi` comes after this line
from salfastapi import app, settings, db  # noqa
from salfastapi.cli import create_user, cli  # noqa
